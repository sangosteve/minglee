import { pgTable, uuid, varchar, text, timestamp, unique, boolean, foreignKey, type AnyPgColumn, integer, index, jsonb, doublePrecision, pgEnum } from "drizzle-orm/pg-core"
...
export const conversations = pgTable("conversations", {
	...
	index("idx_conversations_tag_ids").using("gin", table.tagIds.asc().nullsLast().op("array_ops")),
	foreignKey({
...
export const contacts = pgTable("contacts", {
	...
	index("idx_contacts_tag_ids").using("gin", table.tagIds.asc().nullsLast().op("array_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const quickReplies = pgTable("quick_replies", {
	...
	index("idx_quick_replies_media_attachment_ids").using("gin", table.mediaAttachmentIds.asc().nullsLast().op("array_ops")),
